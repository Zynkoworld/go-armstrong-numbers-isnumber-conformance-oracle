# zynko-oracle · `go-armstrong-numbers-isnumber-conformance-oracle`

**A deterministic, re-checkable conformance oracle for `armstrong-numbers` (go).**
...
## Provenance
Reference: the Exercism reference solution for `armstrong-numbers` (go; MIT, Exercism), body unchanged. Proven by the exercism testsuite (pin=1ce51dae877271b4), re-executed by harvest in a sealed sandbox (unshare -rn) before this bundle was generated.
